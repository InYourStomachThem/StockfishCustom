...
namespace Stockfish
{
  ...
  template <>
  void Tune::Entry<int>::init_option() { make_option(name, value, range); }
  ...
  template <>
  void Tune::Entry<Value>::init_option() { make_option(name, value, range); }
  ...
  template <>
  void Tune::Entry<Tune::PostUpdate>::read_option() { value(); }
